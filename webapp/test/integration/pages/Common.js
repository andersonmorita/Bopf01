sap.ui.define([
	...
	return Opa5.extend("zbopf.ZProjectTestBopf.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["zbopf/ZProjectTestBopf/localService/mockserver"], function (mockserver) {
